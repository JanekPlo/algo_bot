...
- **MR-Session 4 (full v2 sweep on nautilus) — REVISION 4 CORRECTION /
  ...
  core Revision 1 `657e9101…c08e1a` i Revision 2 `0bb1ff7b…ef2841` są zachowane
  wyłącznie audytowo. Pilot Revision 2 ujawnił przed metric read, że niedodatni
  ...
  outcome-blind funding midpoint mismatch; po jego korekcie core
  `97732750…89ba58` został zamrożony na docelowym VPS-ie. Pilot Revision 3
